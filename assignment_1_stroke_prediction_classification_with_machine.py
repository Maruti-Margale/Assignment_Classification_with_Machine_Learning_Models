# -*- coding: utf-8 -*-
"""Assignment 1 Stroke Prediction  : Classification with Machine.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1C1NNexMSpv2EMLSCgGqNivn4tEnZ7uVl
"""
...
target = df.groupby('work_type')['stroke'].mean()
df['work_type'] = df['work_type'].map(target)
